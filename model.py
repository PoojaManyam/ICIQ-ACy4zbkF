...
def predict_device(your_model, input_data):
    try:
        result = your_model.predict(input_data)

        if result is not None and result.shape == (1, 4):
            class_labels = ['headphones', 'laptop', 'phone', 'usbcables']
